...
# sample from dataset
sample_i = 1
# Number of anomaly dimensions 1-10
anom_dims = 5
...
data = np.load("/Users/casperbakker/PycharmProjects/PythonProject/Tests/Data_input/"+process+"/data.npy")
anom = np.load("/Users/casperbakker/PycharmProjects/PythonProject/Tests/Data_input/"+process+"/anom.npy")[sample_i]

data = dm.Mixer(data[:,:,:,1], data[:,:,:,0], anom_dims)
data = data[sample_i]
