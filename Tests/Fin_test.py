...
data = np.load("/Users/casperbakker/PycharmProjects/PythonProject/Tests/Data_input/Financial/FinData.npy")
anom = np.load("/Users/casperbakker/PycharmProjects/PythonProject/Tests/Data_input/Financial/FinData_anom.npy")
