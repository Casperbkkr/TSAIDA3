...
# Number of dimensions of data set that are sampled
dims = 20
...
data = np.load("/Users/casperbakker/PycharmProjects/PythonProject/Tests/Data_input/ESA/ESA_np.npy")[:,:20]
anom = np.load("/Users/casperbakker/PycharmProjects/PythonProject/Tests/Data_input/ESA/ESA_anom.npy")
